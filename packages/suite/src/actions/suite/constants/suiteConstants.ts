...
export const CONNECT_INITIALIZED = '@suite/@onekeyhq/connect-initialized';
...
export const SET_UNLOCK_PIN = '@suite/set-unlock-pin';
export const SET_SHOW_PASSPHRASE_SWITCH_ACCOUNT = '@suite/show-passphrase-switch-account';
